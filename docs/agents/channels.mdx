...
Each environment gets its own dedicated Slack app. OpenComputer creates it
from the capabilities declared in code and installs it into your workspace;
you approve the installation in Slack. Nothing about the app is copied by
hand.
...
5. Approve the installation on the Slack page that opens. You are returned to
...
If Slack's page is closed before approval, the created app is kept: open
Connections again and choose **Authorize in Slack**. When the outcome of app

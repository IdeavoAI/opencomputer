...
Deploy the agent, open its project in the OpenComputer dashboard, select the
environment and open **Connections**. Install the managed OpenComputer GitHub
App into a user or organization account. GitHub lets the installer select all repositories or a

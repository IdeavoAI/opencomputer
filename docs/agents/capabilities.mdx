...
| Connected service | Gmail, Calendar, Drive, Sheets or GitHub, on someone's connected account | OpenComputer attaches and refreshes the credential | `useService("gmail")`, then `callService()` in a tool |

...
| `slack_manifest_rejected` | Slack rejected the generated app configuration; `pointer` names the field |
...
| `slack_setup_superseded` | A manual connection or reconnect completed first |
